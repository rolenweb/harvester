...
/**
 * UsaLocalPharmacy1Search represents the model behind the search form about `common\models\UsaLocalPharmacy1`.
 */
class UsaLocalPharmacy1Search extends UsaLocalPharmacy1
{
    /**
     * @inheritdoc
     */
