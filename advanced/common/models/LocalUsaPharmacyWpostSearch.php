...
/**
 * LocalUsaPharmacyWpostSearch represents the model behind the search form about `common\models\LocalUsaPharmacyWpost`.
 */
class LocalUsaPharmacyWpostSearch extends LocalUsaPharmacyWpost
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['key', 'title', 'street_address', 'city_state', 'phone', 'website', 'open_details', 'description', 'extra_phones', 'years_in_business', 'brands', 'payment', 'categories'], 'safe'],
        ];
    }
    ...
    {
        $query = LocalUsaPharmacyWpost::find();
